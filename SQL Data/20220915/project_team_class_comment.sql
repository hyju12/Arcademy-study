...
CREATE TABLE `class_comment` (
  ...
  `com_nick` varchar(30) DEFAULT NULL,
  `com_content` text,
...
LOCK TABLES `class_comment` WRITE;
/*!40000 ALTER TABLE `class_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `class_comment` ENABLE KEYS */;
UNLOCK TABLES;
