...
<body>
	<div>
		<header>
			...
			<div>
				<span>마이페이지 </span> <span>|</span> <span><a href="main_Index.html">로그아웃</a></span>
			</div>
		</header>
		<nav>
			<div>
				<ul>
					<li>반려동물자랑</li>
					<li><a href="ClassViewListboardList.bo">교육관리</a></li>
					<li>커뮤니티</li>
					<li>위치안내</li>
					<li>중고물품</li>
					<li>돌봄신청</li>
	...
	<section>
		...
		<form action="db_Search.jsp">
			<div
				...
				<input type="text" name="search" placeholder="검색어를 입력하세요"
					style="border: 0;border-right: 2px solid #c7c7c7; width: 300px; margin-top: 7px; font-size: 14px;">
		...
		<table>
			...
			<%
				ArrayList<CntDTO> list = act.printAll();
